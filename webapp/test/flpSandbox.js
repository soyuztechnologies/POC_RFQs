		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RequestsforQuotation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RequestsforQuotation-display": {
								"semanticObject": "RequestsforQuotation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=soyz.dev.poc.pocproject",
									"url": sap.ui.require.toUrl("soyz/dev/poc/pocproject")
								}
							}
						}
					}
